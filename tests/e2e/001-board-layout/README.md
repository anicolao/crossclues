...
![The table opens with the standard four by four layout](./screenshots/000-four-card-layout.png)
...
![A player expands the table to five by five](./screenshots/001-five-card-layout.png)
